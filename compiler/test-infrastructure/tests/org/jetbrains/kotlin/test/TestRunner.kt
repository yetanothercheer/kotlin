    ...
    private fun runTestImpl(@TestDataFile testDataFileName: String) {
        ...
        try {
            for (module in modules) {
                val sourcesArtifact = ResultingArtifact.SourcesArtifact()
...
private fun AnalysisHandler<*>.hackyProcess(module: TestModule, artifact: ResultingArtifact<*>) {
    ...
    (this as AnalysisHandler<ResultingArtifact.SourcesArtifact>)
        .processModule(module, artifact as ResultingArtifact<ResultingArtifact.SourcesArtifact>)
}
...
private fun AbstractTestFacade<*, *>.hackyTransform(
    ...
    @Suppress("UNCHECKED_CAST")
    return (this as AbstractTestFacade<ResultingArtifact.SourcesArtifact, ResultingArtifact.SourcesArtifact>)
        .transform(module, artifact as ResultingArtifact<ResultingArtifact.SourcesArtifact>)
}
