...
) : AbstractTestFacade<ResultingArtifact.SourcesArtifact, R>() {
    final override val inputKind: TestArtifactKind<ResultingArtifact.SourcesArtifact>
        get() = SourcesKind

    abstract fun analyze(module: TestModule): R

    final override fun transform(module: TestModule, inputArtifact: ResultingArtifact.SourcesArtifact): R {
        // TODO: pass sources
