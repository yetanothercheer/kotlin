...
internal class KtFirSyntheticJavaPropertySymbol(
    ...
    override val extensionReceiver: KtReceiverTypeAndAnnotations? by firRef.withFirAndCache { fir ->
        fir.receiverTypeRef?.let { typeRef ->
            KtFirReceiverTypeAndAnnotations(fir, typeRef, resolveState, token, builder)
        }
    }
